...
import com.example.ecommercestore.databinding.FragmentOrderDetailBinding
import com.example.ecommercestore.models.order.OrderStatus
import com.example.ecommercestore.models.order.getOrderStatus
...
class OrderDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        billingProductsAdapter.diff.submitList(order.products)
    }
